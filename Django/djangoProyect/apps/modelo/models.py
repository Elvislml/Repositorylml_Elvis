...
class Cliente(models.Model):
    ...
    genero = models.CharField(max_length = 30, choices = listaGenero, default = "femenino", null=False)
...
class Transaccion(models.Model):
    ...
    trasanccion_id = models.AutoField(primary_key = True)
    fecha = models.DateTimeField(auto_now_add = True, null = False)
    tipo = models.CharField(max_length = 30, choices = listaTransaccion, default = 'deposito')
